...
void RL_binary(uint64_t* base, uint64_t* exp, uint64_t* N, uint64_t* res);
bool check_data(uint64_t* x, uint64_t* y);
bool masking(uint64_t input, int n);
void mod_exp(uint64_t* A, uint64_t* B, uint64_t* N);
